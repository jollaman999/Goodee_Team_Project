...
<div style="margin-left: 100px; margin-right: 100px">
    <form class="contact100-form validate-form" action="update.shop" name="f" method="post">
        ...
        <div class="wrap-input100">
            ...
            <input class="input100" type="text" name="id" value="${member.id}" readonly>
        ...
        <div class="wrap-input100 validate-input" data-validate="이메일 중복확인을 해주세요!">
            <i class="input100 fa fa-envelope fa-fw"
               style="position: absolute; margin-top: 25px; margin-left: 23px; color: #828282"></i>
            <input class="input100" type="text" name="email" placeholder="E-MAIL" onclick="win_email_check()" value="${member.email}" readonly>
            <span class="focus-input100"></span>
        </div>
        ...
        <div class="wrap-input100 validate-input" data-validate="이름을 입력해주세요!">
            <i class="input100 fa fa-user-o fa-fw"
               style="position: absolute; margin-top: 25px; margin-left: 23px; color: #828282"></i>
            <input class="input100" type="text" name="name" placeholder="NAME" value="${member.name}">
            <span class="focus-input100"></span>
        </div>
        ...
        <div class="wrap-input100 validate-input" data-validate="전화번호를 입력해주세요!">
            <i class="input100 fa fa-phone fa-fw"
               style="position: absolute; margin-top: 25px; margin-left: 23px; color: #828282"></i>
            <input class="input100" type="phone" name="phone" placeholder="PHONE" value="${member.phone}"
        ...
        <div class="wrap-input100 validate-input" data-validate="주소를 입력해 주세요!">
            <i class="input100 fa fa-address-card fa-fw"
               style="position: absolute; margin-top: 25px; margin-left: 23px; color: #828282"></i>
            <input class="input100" type="text" name="address" id="address" placeholder="ADDRESS" onclick="execDaumPostcode()" value="${member.address}"
                   readonly>
            <span class="focus-input100"></span>
        </div>
        ...
        <div class="wrap-input100">
            <i class="input100 fa fa-home fa-fw"
               style="position: absolute; margin-top: 25px; margin-left: 23px; color: #828282"></i>
            <input class="input100" type="text" name="address_detail" placeholder="ADDRESS DETAIL" value="${member.address_detail}">
            <span class="focus-input100"></span>
        </div>
        ...
        <div class="wrap-input100 validate-input" data-validate="주소란을 클릭하여 우편번호를 입력해 주세요!">
            <i class="input100 fa fa-envelope-open-o fa-fw"
               style="position: absolute; margin-top: 25px; margin-left: 23px; color: #828282"></i>
            <input class="input100" type="text" name="postcode" id="postcode" placeholder="POSTCODE" value="${member.postcode}" onkeydown="onlyNumber()">
            <span class="focus-input100"></span>
        </div>

        <div class="container-contact100-form-btn">
            <a href="javascript:join_submit()" class="contact100-form-btn">수정 하기</a>
        </div>
    </form>
</div>
...
<script src="${path}/js/submitform/submitform-edit.min.js"></script>
</body>
</html>