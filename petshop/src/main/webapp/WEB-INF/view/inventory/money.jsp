...
<c:forEach items="${moneyList}" var="money">
     <tr>
     <td><fmt:formatDate value="${money.update_time}" pattern="yyyy-MM-dd"/></td>       
     <td><fmt:formatNumber type="CURRENCY" pattern="###,###" value="${money.price_total}"/>\</td>
...
<!-- 테이블 바 이름 -->        
        <tr>
            ...
            <th>총판매금</th>
<!-- 아이템 리스트 가져오기 -->
<c:forEach items="${moneyList2}" var="money2">
     <tr>
     <td><fmt:formatDate value="${money2.update_time}" pattern="MM"/>월</td>   
     <td><fmt:formatNumber type="CURRENCY" pattern="###,###" value="${money2.price_total}"/>\</td>
    </tr></c:forEach></tr>                         
</table><br><br><br><br><br><br>  <!--  테이블 종료  -->        
...
<!-- 테이블 바 이름 -->        
        <tr>
            ...
            <th>총판매금</th>
<!-- 아이템 리스트 가져오기 -->
<c:forEach items="${moneyList3}" var="money3">
     <tr>   
     <td><fmt:formatDate value="${money3.update_time}" pattern="yyyy"/>년</td>       
     <td><fmt:formatNumber type="CURRENCY" pattern="###,###" value="${money3.price_total}"/>\</td>
    </tr></c:forEach></tr>                         
</table><br><br><br><br><br><br>  <!--  테이블 종료  -->    
