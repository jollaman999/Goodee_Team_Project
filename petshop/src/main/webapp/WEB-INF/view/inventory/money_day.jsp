...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawBasic() {
            ...
            data.addColumn('number', '날짜별 총판매금');
            ...
            data.addRows([
                ...
                ["<fmt:formatDate value="${dayprofit.update_time}" pattern="yyyy"/>년 <fmt:formatDate value="${dayprofit.update_time}" pattern="MM"/>월 <fmt:formatDate value="${dayprofit.update_time}" pattern="dd"/>일", ${dayprofit.price_total}],
                </c:forEach>
            ]);
