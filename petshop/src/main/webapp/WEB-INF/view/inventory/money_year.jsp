...
<h3 style="text-align: center; margin-bottom: 50px">년별 수익</h3>
...
<div id="printme">
    <table id='tblExport'>
        ...
        <c:forEach items="${year_profit}" var="yearprofit">
            <tr>
                <td><fmt:formatDate value="${yearprofit.update_time}" pattern="yyyy년"/></td>
                <td><fmt:formatNumber type="currency" pattern="###,###" value="${yearprofit.price_total}"/>\</td>
                <td>
                    <c:choose>
