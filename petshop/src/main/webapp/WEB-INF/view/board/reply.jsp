...
%>
<form name="f" method="post" action="reply.shop" enctype="multipart/form-data">
    ...
    <table>
        <tr>
            <td>제목</td>
            <td><input type="text" name="title" size="100" value="RE: ${board.title}: "></td>
        </tr>
        ...
        <tr>
            <td colspan="2" style="border: 0; padding-top: 20px">
                <input class="w3-button w3-bar-item w3-deep-purple"
                       type="button" onclick="board_submit()" value="답변글 등록" style="margin-right: 10px">
                <input class="w3-button w3-bar-item w3-deep-purple"
